...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  variant?: 'primary' | 'secondary' | 'ghost' | 'success' | 'warning' | 'destructive' | 'gradient' | 'premium' | 'teal' | 'amber';
  size?: 'sm' | 'md' | 'lg' | 'xl';
...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "inline-flex items-center justify-center gap-2 rounded-full font-medium transition-all duration-300 disabled:opacity-50 disabled:pointer-events-none active:scale-95 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-neutral-900";
