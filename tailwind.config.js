...
module.exports = {
  ...
  plugins: [
    ...
    // Custom plugin for PulseSync-inspired utilities - v4 compatible
    function({ addUtilities, theme }) {
      const newUtilities = {
        ...
        // Mathematical harmony utilities
        ...
        '.animate-stagger-1': { animationDelay: '0.1s' },
        '.animate-stagger-2': { animationDelay: '0.2s' },
        '.animate-stagger-3': { animationDelay: '0.3s' },
        '.animate-stagger-4': { animationDelay: '0.4s' },
        '.animate-stagger-5': { animationDelay: '0.5s' },
        // Premium spacing
        ...
        '.premium-section-sm': { padding: '3rem 0' },
        '.premium-section-lg': { padding: '8rem 0' },
        // Premium effects
        ...
        // Phase 12E: 3D Spline Background Utilities
        '.bg-3d-spline': {
          background: 'linear-gradient(135deg, #0A0A0A 0%, #171717 100%)',
        },
        '.bg-3d-spline-overlay': {
          background: 'rgba(0, 0, 0, 0.8)',
          backdropFilter: 'blur(10px)',
        },
        '.text-3d-spline-primary': {
          color: '#10B981',
        },
        '.text-3d-spline-accent': {
          color: '#F59E0B',
        },
        '.text-3d-spline-energy': {
          color: '#F97316',
        },
        '.border-3d-spline': {
          borderColor: '#10B981',
        },
        '.border-3d-spline-accent': {
          borderColor: '#F59E0B',
        },
        '.shadow-3d-spline': {
          boxShadow: '0 20px 40px rgba(16, 185, 129, 0.1), 0 10px 20px rgba(0, 0, 0, 0.2)',
        },
        '.shadow-3d-spline-glow': {
        ...
        // 3D Spline responsive utilities
        '.bg-3d-spline-mobile': {
          '@media (max-width: 768px)': {
            background: 'linear-gradient(135deg, #0A0A0A 0%, #171717 100%)',
          },
        },
        '.text-3d-spline-mobile': {
          '@media (max-width: 768px)': {
            color: '#FFFFFF',
          },
        },
